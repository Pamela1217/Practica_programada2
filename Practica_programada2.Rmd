...
f. Escriba el código que exporte los datos en un excel, de tal manera que cada pestaña tenga solamente los datos de una categoría de AQI. (Es decir una pestaña para las ciudades cuya categoría es “Good” o “Buena”, otra para los que la categoría es “Moderate” y así para cada cateoría).
...
for (categoria in aqi_categorias) {
